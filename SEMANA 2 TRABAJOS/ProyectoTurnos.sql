...
--
-- Host: localhost    Database: clinicaT
-- ------------------------------------------------------
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'eb994696-b534-11f0-a376-862c8c3e8d5c:1-10';
...
CREATE TABLE `turnos` (
  ...
  CONSTRAINT `turnos_ibfk_3` FOREIGN KEY (`id_consultorio`) REFERENCES `consultorios` (`id_consultorio`)
...
--
-- Dumping routines for database 'clinicaT'
--
...
-- Dump completed on 2025-10-29 21:21:15
